  ...
  return (
    <div className="flex flex-col w-full justify-center">
        <Banner
            ...
            title="Contacto"
            description="Mejora tu rutina de cuidado personal con la experiencia de nuestros expertos en belleza"
            upperCaseTitle
            upperCaseDescription
            fontBoldDescription
        />
        <div className="bg-slate-200 w-full py-14 ">
            <div className="flex flex-col md:flex-row container m-auto bg-teal-600">
                <div className="flex flex-col w-full text-center text-white px-6 text-xs md:text-base">
                    <div className="flex flex-col mt-8 gap-4 items-center">
                        <CustomLabel title="Horario" />
                    ...
                    <div className="flex flex-col mt-8 gap-4 items-center">
                        <CustomLabel title="Direccion" />
                        <p>
                            Av. Privada, #68 Torre empresarial Esmeralda local 401, <br />
                            Santo Domingo, Dominican Republic
                        </p>
                    </div>
                    <div className="flex mt-8 mb-6 gap-4 w-full justify-center">
                        <div className='flex gap-2'>
                            <div className='flex items-center justify-center p-1 w-8 h-8 rounded-full border-white border-2 bg-red-400'>
                ...
                <div className="w-full p-4">
                    <img className="rounded-md" src="/images/contact/location.png" />
                </div>
            </div>
        </div>
    </div>
